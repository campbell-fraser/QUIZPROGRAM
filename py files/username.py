...
while Continue == False:
    ...
    if login == "login":
        ...
        if os.path.exists(r'''G:\\QUIZPROGRAM\\'''+str(username)+"ACCOUNTDETAILS"+'''.txt''') == True:
        ...
        if os.path.exists(r'''G:\\QUIZPROGRAM\\'''+str(username)+"ACCOUNTDETAILS"+'''.txt''') == False:
    ...
    #account creation loop, only proceeding when original account info is input
        ...
        if os.path.exists(r'''G:\\QUIZPROGRAM\\'''+str(username)+"ACCOUNTDETAILS"+'''.txt''') == False:
            ...
            userCreate.close()
            login = "login"
        elif os.path.exists(r'''G:\\QUIZPROGRAM\\'''+str(username)+"ACCOUNTDETAILS"+'''.txt''') == True:
